          ...
          <div>
            ...
            {(() => {
              ...
              return (
                <p className="mt-3 text-[8px] tracking-[0.15em] leading-relaxed" style={{ color: '#9a6e00' }}>
                  * Esta extracción tomará más de un día. Tiempo estimado: {minDays} a {maxDays} días laborales.
                </p>
              );
            })()}
            ...
            <div className="mt-4 flex flex-col gap-3">
              ...
              <div className="flex gap-6 flex-wrap">
                <div className="flex items-center gap-2">
                  <input
                    ...
                    step="0.1"
                    value={totalFilledKg}
                    onChange={e => setTotalFilledKg(e.target.value)}
                    placeholder="—"
                ...
                <div className="flex items-center gap-2">
                  <input
                    ...
                    step="0.1"
                    value={totalEmptyKg}
                    onChange={e => setTotalEmptyKg(e.target.value)}
                    placeholder="—"
                    className="w-20 border-b bg-transparent py-1.5 text-sm font-light outline-none text-center"
                    style={{ borderColor: 'var(--border)', color: 'var(--dark)' }}
                  />
              ...
              {(() => {
                ...
                const hasF = totalFilledKg !== '' && !isNaN(filled);
                const hasE = totalEmptyKg  !== '' && !isNaN(empty);
                if (!hasF || !hasE || filled <= empty) return null;
                return (
            ...
            <div>
              <p className="text-[9px] tracking-[0.4em] mb-3" style={{ color: 'var(--muted)' }}>
                ...
                {estimatedDuration !== null && (
                  <span style={{ color: 'var(--border)' }}> — EST. {formatDuration(estimatedDuration)}</span>
                )}
              </p>
